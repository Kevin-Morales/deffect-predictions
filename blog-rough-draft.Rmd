---
title: "Software Deffect Prediction Using Supervised Models"
author: "Kevin Morales"
date: "`r Sys.Date()`"
---


```{r setup, include=FALSE, fig.width = 6.5, fig.height = 6.5}
...
Nevertheless, it is necessary to investigate whether computers can do better at finding deffects through predictive modeling and machine learning, since there are legacy code bases to maintain, and we are still far from software that can produce more software.
...
predictions_glm <- predict(model_glm, x_test)
acc_glm <- mean(predictions_glm == y_test)
...
acc_svm <- mean(predictions_svm == y_test)
